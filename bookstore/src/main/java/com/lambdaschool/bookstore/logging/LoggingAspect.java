package com.lambdaschool.bookstore.logging;
...
{
    @Around(value = "@within(com.lambdaschool.bookstore.logging.Loggable) || @annotation(com.lambdaschool.bookstore.logging.Loggable)")
